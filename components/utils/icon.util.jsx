...
// Add commonly used community icons
...
export default function Icon({ icon }) {
	...
	// Convert pro icon types to free equivalents
	const convertIconType = (type) => {
		switch (type) {
			case 'fad':
			case 'fat':
			case 'fal':
	...
	return (
		<FontAwesomeIcon icon={[ convertIconType(iconType), stateIconKey ]} />
	)
}
